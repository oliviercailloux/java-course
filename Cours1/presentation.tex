...
\begin{frame}
	...
	\end{itemize}
\end{frame}
%TODO conseils généraux
%simple !
%Si fonctionne pas : faire plus simple !
%Exclure bugs possibles.
%Procéder pas à pas
%Comprendre
%Se méfier du code auto-généré
%Chisir approche cohérente
%mélange deux tutos : problèmes potentiels (≠ versions; ≠ annotations…)
