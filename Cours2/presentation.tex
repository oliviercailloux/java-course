...
\begin{frame}
	...
	\begin{itemize}
		...
		\item \texttt{git checkout truc} : change HEAD et {\tiny éventuellement} WD
		\item avoir un WD propre avant un checkout !
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item \texttt{git init} : dépôt git vide dans répertoire courant (rien n’est traqué)
