...
== Interface extension
Prerequisite: read and understand https://github.com/oliviercailloux/java-course/blob/master/Syntax/Interfaces.adoc[Interfaces].
...
== Class extension
Prerequisite: read and understand https://github.com/oliviercailloux/java-course/blob/master/Syntax/Classes%20as%20concept.adoc[Classes as concept].
