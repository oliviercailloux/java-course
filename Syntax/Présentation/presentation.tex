...
class Maths {
	...
	\begin{itemize}
		...
		\item Son chemin (relatif au répertoire source) doit être ? \onslide<3->{\texttt{io/github/oliviercailloux/math/Maths.java}}
		\item[$⇒$] autant de répertoires que de packages dans source
		\item Chemin (relatif au répertoire cible) du fichier compilé ? \onslide<4->{\texttt{io/github/oliviercailloux/math/Maths.class}}
	\end{itemize}
\end{frame}
