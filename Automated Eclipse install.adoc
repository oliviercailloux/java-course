...
* `/usr/local/share/eclipse-jee-2018-12-R-linux-gtk-x86_64/eclipse -nosplash -application org.eclipse.equinox.p2.director -repository "https://download.jboss.org/jbosstools/photon/stable/updates/" -installIU "org.jboss.ide.eclipse.as.feature.feature.group, org.jboss.tools.usage.feature.feature.group"`
