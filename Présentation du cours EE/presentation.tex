...
\begin{frame}
	...
	\end{itemize}
	\begin{center}
		\uncover<2->{\includegraphics[clip, trim=0 \agBottomHalf{} 2\agPanelWidth{} \agTopCrop{}, width=\agWidth]{Demarcheinformatique.jpg}}%
		\uncover<3->{\includegraphics[clip, trim=\agPanelWidth{} \agBottomHalf{} \agPanelWidth{} \agTopCrop{}, width=\agWidth]{Demarcheinformatique.jpg}}%
		\uncover<4->{\includegraphics[clip, trim=2\agPanelWidth{} \agBottomHalf{} 0 \agTopCrop{}, width=\agWidth]{Demarcheinformatique.jpg}}%
			
		\uncover<5->{\includegraphics[clip, trim=0 \agBottomCrop{} 2\agPanelWidth{} \agTopHalf{}, width=\agWidth]{Demarcheinformatique.jpg}}%
		\uncover<6->{\includegraphics[clip, trim=\agPanelWidth{} \agBottomCrop{} \agPanelWidth{} \agTopHalf{}, width=\agWidth]{Demarcheinformatique.jpg}}%
		\uncover<7>{\includegraphics[clip, trim=2\agPanelWidth{} \agBottomCrop{} 0 \agTopHalf{}, width=\agWidth]{Demarcheinformatique.jpg}}%
	\end{center}
\end{frame}
