...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Bases théoriques de Java EE.
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item À remettre avant le jour du cours $x + 1$
...
\begin{frame}
	...
	\begin{itemize}
		\item Durant chaque cours : je tire des personnes au hasard
...
\begin{frame}
	...
	\begin{itemize}
		\item Étudiants en commun avec cours Dan Dimcea : 6 ECTS
		\item \{[(25 à 30h / ECTS) × 6 ECTS] − 48 h\} / 7 inter-séances
		\item 18 heures de travail entre chaque séance
		\item Autres étudiants : 9 heures entre chaque séance
		\item Peuvent donc sauter une séance sur deux
		\item Ou auront meilleure note
		\item Ou binôme se sépare pour une partie du travail
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Par binôme : Création d’un problème git (\emph{issue}) sur projet Git
		\item Par binôme : Commit branche perso, nom branche = n° issue
		\item Par chacun : Indication sur MyCourse de l’URL issue travaillée + nom binôme
		\item Conseil : \emph{vérifier} que je verrai votre code en effectuant un nouveau clone vous-même
		\item Voir détails sur MyCourse
	\end{itemize}
\end{frame}
