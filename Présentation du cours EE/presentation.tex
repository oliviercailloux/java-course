...
\begin{frame}
	...
	\newlength{\agPanelHeight}
	\setlength{\agPanelHeight}{\agTotHeight / 2}
%	\newlength{\agPanelWidth}
%	\setlength{\agPanelWidth}{\agTotWidth / 3}
	\newlength{\agHeight}
	\setlength{\agHeight}{2.5cm}

%	\printlength{\agTotWidth}
%	\printlength{\agPanelWidth}

%https://tex.stackexchange.com/questions/118494/how-to-use-only-half-an-image/118495#118495
%\includegraphics[trim=0.5\imagewidth{} 0 0 0, clip, width = 0.1\imagewidth{}]{Demarcheinformatique.jpg}
%	\hfill\includegraphics[clip, trim=0 \the\textwidth{} 13cm 0, height=\agHeight]{Demarcheinformatique.jpg}%
%	\includegraphics[clip, trim=6.5cm 6.5cm 6.5cm 0, height=\agHeight]{Demarcheinformatique.jpg}
%Fails (also with GNU.png)
%	\includegraphics[clip, trim=0 0 0.5\textwidth{} 0, height=10cm]{Demarcheinformatique.jpg}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Fonctionnalités de l’application décrites de manière vague : à vous de m’interroger
	\end{itemize}
	\centering\includegraphics[height=\textheight - 93.5pt]{Demarcheinformatique.jpg}
\end{frame}
