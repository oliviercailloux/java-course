...
If your dependency graph is subtle so that you risk to run into such issues, you might prefer to selectively depend on the exact specifications you need. Looking at the https://search.maven.org/remotecontent?filepath=javax/javaee-api/7.0/javaee-api-7.0.pom[Java EE 7 POM] (and https://search.maven.org/remotecontent?filepath=javax/javaee-web-api/7.0/javaee-web-api-7.0.pom[Java EE Web 7 POM]) may help for this.
