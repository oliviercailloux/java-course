...
* Make sure your Maven `groupId` is unique. For this, prefix it with a domain name you control, inverted, with underscores replaced by hyphens. Example: `io.github.oliviercailloux.something`.
