...
== Installing the JDK
For this course, you need Java 21 or more recent.
...
* On Debian, install https://packages.debian.org/search?keywords=openjdk-21-jdk&searchon=names&exact=1&suite=all&section=all[openjdk-21-jdk] (and https://packages.debian.org/search?keywords=openjdk-21-source&searchon=names&exact=1&suite=all&section=all[openjdk-21-source] to have the Javadoc accessible even when coding offline).
