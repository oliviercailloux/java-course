...
== Prerequisites
You know algorithmics and, preferrably, the basic syntax of Java (or a closeby language such as Python). If you have followed an algorithmics course with illustrations and exercices in Java, you satisfy the prerequisites.
...
* Basic concepts and structures of Java: variables; types; subroutines; control structures; identifiers… [Should be known or easy]
** https://github.com/oliviercailloux/java-course/raw/master/Syntaxe/presentation.pdf[Syntax] (without classes and objects), http://www.lamsade.dauphine.fr/~airiau/Teaching/L3-Java/cours1.pdf[Airiau C1] (compil, p. 16 to 20) (TODO : main, corriger a = 2)
* With jshell:
** Show the result of multiplying 4659 and 23, assigning these numbers to variables before multiplying them
** Show the greatest divisor of 4659 different than 4659 (use the `%` operator and a loop)
...
* Syntax: classes (no objects)
* With a text editor: define a class containing the method 
...
* http://math.hws.edu/javanotes/c1/[ES1.1], 1.2, 1.3, 1.4, 2 intro, 2.1, 2.2, 2.3.3, 2.4.1, 2.5, 2.6.6 [Should be known or easy]
* For beginners in Java: ES3 intro to 3.6
* ES1.5
* http://math.hws.edu/javanotes/c2/[ES2.2.1], 2.3.1, 2.3.2, 2.4.6 [I]
* ES1.6, 1.7 [O]

*Exercices*

* (link:http://math.hws.edu/javanotes/c2/exercises.html[EE2.1] to 2.6, supposedly known)
