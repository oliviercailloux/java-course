...
* Comparable, Comparator, Maps (see also: Airiau)
...
** http://math.hws.edu/javanotes/c10/exercises.html[EE10.6] (you may use `List` implementations, but not `Map`, of course)
