...
** More advanced, and more elegant: instead of defining a class `Pair<E>` from scratch, define a class `HomogeneousPair<E>` that extends your existing class `Pair<L, R>`. Do the rest of the exercice above.
