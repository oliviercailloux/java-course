...
** Two roles; static VS non-static (behavior depends on values of parameters and instance attributes)
...
* Graded exercice similar to https://github.com/oliviercailloux/java-course/blob/master/Git/Dep-Git.adoc[Dep-Git]. Your GitHub username and git `user.name` must be identical (and for all exercices to come as well).
* https://github.com/oliviercailloux/java-course/tree/master/Maven[Maven], and *exercices*
