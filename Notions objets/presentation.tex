...
\begin{frame}
	...
	\begin{itemize}
		...
		\item \texttt{"Hello".\jseref[omitfqname]{java.lang/String\#indexOf-java.lang.String-}("l");} ⇒ \onslide<1>{?}\onslide<2->{\texttt{2}}
		\item \texttt{"Hello".\jseref[omitfqname]{java.lang/String\#substring-int-int-}(1, 3);} ⇒ \onslide<1-2>{?}\onslide<3>{\texttt{"el"}}
	\end{itemize}
