...
\begin{frame}
	...
	\begin{itemize}
		\item Injection de ressources via \jdocRef[base url = https\string://javaee.github.io/javaee-spec/javadocs/, parameters style = hyphen]{@javax.annotation/Resource}
