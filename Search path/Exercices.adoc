...
* Compile `mypackage.one.MyClass` manually using a terminal, with `javac` (see https://docs.oracle.com/en/java/javase/11/tools/javac.html[javac] doc).
...
* Run the program using a terminal, with `java` (see https://docs.oracle.com/en/java/javase/11/tools/java.html[java] doc). Check that it says Hello.
