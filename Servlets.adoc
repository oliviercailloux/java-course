...
You then package your application as a WAR (Web ARchive format), and deploy it to your application server. (Exact procedures to do this depend on your IDE for the WAR and on your application server for the deployment, see link:App%20servers%20from%20Eclipse.adoc[here] for Eclipse.)
