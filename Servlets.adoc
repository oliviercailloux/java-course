...
NOTE: The reader supposedly has basic knowledge of https://github.com/oliviercailloux/java-course/blob/master/HTTP.adoc[HTTP], https://github.com/oliviercailloux/java-course/blob/master/Maven/README.adoc[Maven] and https://github.com/oliviercailloux/java-course/blob/master/GlassFish.adoc[application servers]. (You are not obliged to use GlassFish, though.)
...
* Log what you do in your servlet code; check that it appears indeed in the log.
