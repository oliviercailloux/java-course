...
NOTE: The reader supposedly has basic knowledge of https://github.com/oliviercailloux/java-course/blob/master/HTTP.adoc[HTTP], https://github.com/oliviercailloux/java-course/blob/master/Maven/README.adoc[Maven] and https://github.com/oliviercailloux/java-course/blob/master/WildFly.adoc[application servers]. (You are not obliged to use WildFly, though.)
...
* create a new folder,
* use https://github.com/oliviercailloux/samples/blob/master/JavaEE-Servlets/pom.xml[this] sample pom,
...
//[source, java]
.An https://github.com/oliviercailloux/samples/blob/master/JavaEE-Servlets/src/main/java/io/github/oliviercailloux/javaee_servlets/servlets/SayHelloServlet.java[example] of a Java EE servlet
--
...
* See link:App%20servers%20from%20Eclipse.adoc[here] for automatic deployment using Eclipse.
...
If you use GlassFish, some useful debugging tips are link:GlassFish.adoc[there].
