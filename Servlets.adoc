...
NOTE: The reader supposedly has basic knowledge of https://github.com/oliviercailloux/java-course/blob/master/HTTP.adoc[HTTP], https://github.com/oliviercailloux/java-course/blob/master/Maven.adoc[Maven] and https://github.com/oliviercailloux/java-course/blob/master/GlassFish.adoc[application servers]. (You are not obliged to use GlassFish, though.)
