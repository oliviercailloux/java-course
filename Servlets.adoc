...
NOTE: The reader supposedly has basic knowledge of link:HTTP.adoc[HTTP], link:Maven.adoc[Maven] and link:Glassfish.adoc[application servers]. (You are not obliged to use Glassfish, though.)
...
To start a Maven compatible web project, create a new folder, use https://github.com/oliviercailloux/samples/blob/master/JavaEE-Servlets/pom.xml[this] sample pom, then import the project into Eclipse.
