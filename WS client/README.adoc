...
* Exercices https://github.com/oliviercailloux/java-course/blob/master/WS%20client/Curl.adoc[using curl]
* Short doc about https://github.com/oliviercailloux/java-course/blob/master/WS%20client/JAX-RS%20client.adoc[JAX-RS client]
* Exercices https://github.com/oliviercailloux/java-course/blob/master/WS%20client/Java.adoc[from Java].
