...
** Hint: if you are uncomfortable with generating random data in Java, you might want to check again the exercices in https://github.com/oliviercailloux/java-course/blob/main/Overview/README.adoc[Overview]
