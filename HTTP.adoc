...
== Appendices
=== Various
* HTTP/2 is standardized by W3C as https://tools.ietf.org/html/rfc7540[RFC 7540] (HTTP/1.1 was previously defined under https://pretty-rfc.herokuapp.com/RFC2616[RFC 2616], now obsolete).
...
=== URIs
* https://pretty-rfc.herokuapp.com/RFC3986[RFC 3986]: Uniform Resource Identifier (URI) Generic Syntax, 2005 (obsoletes RFC 2396).
* A URI with authority has the https://pretty-rfc.herokuapp.com/RFC3986#components[form] scheme://authority path [?query][#fragment] (URIs also exist with different forms such as `mailto:John.Doe@example.com`, `tel:+1-816-555-1212`, ``urn:oasis:names:specification:docbook:dtd:xml:4.1.2``…)
