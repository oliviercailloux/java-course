...
* After `dripMachine.produceCoffee(0.3d)`, `dripMachine.getEnergySpent()` should not throw, and after `dripMachine.produceCoffee(0d)`, `dripMachine.getEnergySpent()` should return `0d` [Energy zero]
