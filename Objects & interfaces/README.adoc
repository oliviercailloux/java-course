...
Hints for self-correction https://github.com/oliviercailloux/java-course/blob/master/Objets/Correction%20of%20Three%20dice.adoc[here]. Do not look at it before having implemented your own version!
