...
== Checked exceptions
Exceptions, checked and unchecked: see this https://www.programcreek.com/2009/02/diagram-for-hierarchy-of-exception-classes/[diagram] or this https://rollbar.com/blog/java-exceptions-hierarchy-explained/#[hierarchy].
