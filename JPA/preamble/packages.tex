...
\usepackage{listings} %typeset source code listings
	\lstset{language=XML, tabsize=2, captionpos=b, keywordstyle=\fontspec{Latin Modern Mono Light}\textbf, emph={}, keywords={}, emphstyle=\fontspec{Latin Modern Mono Light}\textbf, basicstyle=\small\NoAutoSpacing\ttfamily, aboveskip=0pt, belowskip=0pt, showstringspaces=false}
...
%\hypersetup{breaklinks,bookmarksopen,colorlinks=true,urlcolor=blue,hyperfigures=true}
