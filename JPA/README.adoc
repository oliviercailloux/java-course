...
NOTE: The reader supposedly has basic knowledge of JDBC (see https://raw.githubusercontent.com/oliviercailloux/java-course/master/JDBC/presentation.pdf[Présentation]), transactions (see https://raw.githubusercontent.com/oliviercailloux/java-course/master/Concurrence/presentation.pdf[Présentation]) and Eclipse.
