...
%TODO questions hib ; id set when persist? Yes, empirically. Hib et JUL ? (Cf. projet Hib)
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item EJBs : transactions gérées par le conteneur {\tiny (ou utiliser \jeeref[@]{javax.ejb/TransactionManagement})}
