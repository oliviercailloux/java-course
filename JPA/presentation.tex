...
em.persist(e);// $\sffamily \emph{pas} {\tiny{nécessairement}} de requête à ce stade$
...
\begin{frame}
	\frametitle{JTA}
	\begin{itemize}
		\item JTA entity manager (VS : resource-local entity manager)
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Hibernate 5.1 \href{http://docs.jboss.org/hibernate/orm/5.1/quickstart/html_single/}{Getting Started Guide}
