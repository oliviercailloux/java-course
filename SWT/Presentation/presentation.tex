...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Choose your widget using the screenshots (see \href{https://github.com/oliviercailloux/java-course/blob/master/SWT}{doc})
...
\begin{frame}
	...
	\begin{itemize}
		\item SWT through Maven: some trick required, see \href{https://github.com/oliviercailloux/java-course/blob/master/SWT}{doc}
