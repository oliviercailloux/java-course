...
\begin{frame}
	...
	\begin{itemize}
		\item A blatant lie in the name: \only<1>{?}\onslide<2>{it’s not standard!}
...
\begin{frame}
	...
	\begin{minipage}[t]{\textwidth-35mm}
		\begin{itemize}
			\item \href{http://help.eclipse.org/oxygen/advanced/content.jsp?topic=/org.eclipse.platform.doc.isv/reference/api/org/eclipse/swt/widgets/Widget.html}{\texttt{Widget}}: GUI component; can send events; must be disposed
			\item \href{http://help.eclipse.org/oxygen/advanced/content.jsp?topic=/org.eclipse.platform.doc.isv/reference/api/org/eclipse/swt/widgets/Control.html}{\texttt{Control}}: may be put into a composite; has bounds
			\item \href{http://help.eclipse.org/oxygen/advanced/content.jsp?topic=/org.eclipse.platform.doc.isv/reference/api/org/eclipse/swt/widgets/Composite.html}{\texttt{Composite}}: can contain child controls
			\item \href{http://help.eclipse.org/oxygen/advanced/content.jsp?topic=/org.eclipse.platform.doc.isv/reference/api/org/eclipse/swt/widgets/Shell.html}{\texttt{Shell}}: top-level window connected to a display
			\item \href{http://help.eclipse.org/oxygen/advanced/content.jsp?topic=/org.eclipse.platform.doc.isv/reference/api/org/eclipse/swt/widgets/Display.html}{\texttt{Display}}: represents the connection to the native display
		\end{itemize}
	\end{minipage}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Example: \href{http://help.eclipse.org/oxygen/advanced/content.jsp?topic=/org.eclipse.platform.doc.isv/reference/api/org/eclipse/swt/widgets/TableItem.html}{\texttt{TableItem}} represents a row of a \href{http://help.eclipse.org/oxygen/advanced/content.jsp?topic=/org.eclipse.platform.doc.isv/reference/api/org/eclipse/swt/widgets/Table.html}{\texttt{Table}}
		\item \href{http://help.eclipse.org/oxygen/advanced/content.jsp?topic=/org.eclipse.platform.doc.isv/reference/api/org/eclipse/swt/widgets/Item.html}{\texttt{Item}}s are widgets but not controls: their position is {\tiny partly} controlled by their parent
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Choose your widget using the screenshots (see \href{https://github.com/oliviercailloux/java-course/blob/master/SWT/README.adoc}{doc})
...
\begin{frame}
	...
	\begin{itemize}
		\item SWT through Maven: some trick required, see \href{https://github.com/oliviercailloux/java-course/blob/master/SWT/README.adoc}{doc}
