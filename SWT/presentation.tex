...
\begin{frame}
	...
	Simplest approach: 
	\begin{itemize}
		\item The advertiser knows the interested objects and call them
	\end{itemize}
	\begin{center}
		\begin{tikzpicture}
...
\begin{frame}
	...
	\begin{itemize}
		\item SWT through Maven: some trick required, see \href{https://github.com/oliviercailloux/java-course/blob/master/SWT.adoc}{doc}
