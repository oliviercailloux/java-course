...
See https://github.com/oliviercailloux/java-course/raw/master/SWT/Pr%C3%A9sentation/presentation.pdf[présentation]. Instructions for using SWT with Maven are below; and further below, some references.
...
// 510072 - Scripts & tool for publishing to Maven Central should migrate to releng git - maven and SWT
// 520337 - My suggestion
