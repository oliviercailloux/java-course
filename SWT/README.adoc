...
For compatibility with multiple OSes, use Maven profiles. See this https://github.com/oliviercailloux/PDF-p/blob/0daf84096c91186fc2593ef51c60720e8b338e6e/pom.xml[example].
