...
See https://github.com/oliviercailloux/java-course/raw/master/SWT/Presentation/presentation.pdf[presentation]. Instructions for using SWT with Maven are below; and further below, some references.
