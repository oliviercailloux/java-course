...
Travis allows you to configure automatic deployment, run scripts of your own, and https://docs.travis-ci.com/[much more]. https://github.com/oliviercailloux/PDF-p/blob/97737ee5b628f3f5e9755819059c57b36f99483e/.travis.yml[This] example sets up Travis so that a project dependency is cloned from GitHub and installed locally before the main project is built. (This may be useful in case one of the dependency is not pushed to a public Maven repository.)
