...
\begin{frame}[label = Bataille]
	...
	\begin{block}{Popularité}
		...
		\begin{description}[SLF4J]
			\item[\href{https://github.com/search?l=java&q="org.slf4j"&type=Code}{SLF4J}] \num{2 003 451} {\tiny Ou \href{https://github.com/search?l=java&q="org.slf4j.Logger"&type=Code}{org.slf4j.Logger} : \num{1 963 334}}
			\item[\href{https://github.com/search?l=java&q="java.util.logging"&type=Code}{JUL}] \num{2 028 941} {\tiny Ou \href{https://github.com/search?l=java&q="java.util.logging.Logger"&type=Code}{java.util.logging.Logger} : \num{1 683 302}}
		\end{description}
