...
\begin{frame}
	...
	\begin{itemize}
		...
		\item 
    Pondérations {\tiny (\og{}\href{https://en.wikipedia.org/wiki/Ordered_weighted_averaging}{owa}\fg)} projet VS tests : au pire par individu parmi $\set{1/5, 4/5}$
...
\begin{frame}
  ...
  Avec ressources pré-existantes, sans LLM
	\begin{itemize}
...
\begin{frame}
  ...
  LLM autorisés
	\begin{itemize}
		...
		\item Bloquer deux dates de livraison, espacées d’au moins deux semaines
		\item Deux volontaires intégration
