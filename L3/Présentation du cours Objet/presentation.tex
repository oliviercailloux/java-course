...
\begin{frame}
	...
	\begin{itemize}
		\item Technologies omniprésentes %(\#4 In-Demand Remote Tech Skills, 2021, \href{https://insights.dice.com/2021/12/03/top-30-tech-skills-employers-want-from-remote-workers/}{Emsi Burning Glass})
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Vote pour la meilleure application (pour le prestige)
