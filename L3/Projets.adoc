...
** Vous devez utiliser autant que possible les technologies https://github.com/oliviercailloux/java-course/blob/main/Libs.adoc[recommandées dans ce cours] et les standards ISO, W3C et JSR Java (JSON-P ou Jackson et non JSON-B).
