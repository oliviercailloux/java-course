...
* https://github.com/oliviercailloux/java-course/blob/master/Syntax/README.adoc[Syntax]: basics; exercices; classes; Exercice 2 [Should be known or easy]
...
* Prerequisites: https://www.eclipse.org/downloads/packages/[Eclipse IDE] “for Java Developers”; https://git-scm.com/download[git]

* Supposed known: https://github.com/oliviercailloux/java-course/blob/master/Git/README.adoc[Git]; https://github.com/oliviercailloux/java-course/blob/master/Git/Shell.adoc[Shell]; Execution (see above).
