...
[[S12]]
== S12: 22 May
* Maps. Exercice Map. Exercice chess. Exercice EE10.6 (see Collections).

[[S13]]
== S13: 22 May
* Final graded exercice: https://classroom.github.com/a/5XNf2RPK[continents].
** Implement the provided classes and interfaces, respecting the provided contracts and making sure that the provided tests pass.
** You may add methods and classes and tests, but you may not change the provided signatures. 
** Implement the tests in `TestsToProvide` and make sure they pass with any correct implementation
(thus, they may not explicitly refer to your supplementary methods, if you have added some).
** Any missing indication in the statement: you can implement in any reasonable way of your choice.
I will not provide supplementary details or hints. 
** Deadline: 15h46 (plus 5 minutes max with penalty).
** Finished early? Follow the https://github.com/oliviercailloux/java-course/blob/main/Git/Graded%20exercices.adoc[instructions] and wait for my permission before leaving.

* Conclusion and https://i0.wp.com/jonathanbecher.com/wp-content/uploads/2010/05/org-view-by-tree1.png[the alignment problem] (https://www.businessballs.com/amusement-stress-relief/tree-swing-cartoon-pictures-early-versions/[history])
* https://github.com/oliviercailloux/java-course/raw/refs/heads/main/L3/Appr%C3%A9ciation%20Java.odt[Appréciation du cours]

TODO @ home.

* Before end of 13 June: second chance (optional). Weight new is (20 - _l_)/30 with _l_ the number of modified lines.

* Grade tests grade: git coef 1, three other graded tests owa with coefs 2.5, 1.15, 1 with bigger weights to better grades
* Final grade: owa with coefs 0.25, 0.75, with bigger weight to worst grade
