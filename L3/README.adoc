...
* Graded exercice: https://classroom.github.com/a/ychDzzze[dice-roller]. Implement the interface `CyclicDiceRoller`. Your implementation must contain a public no-argument constructor.
