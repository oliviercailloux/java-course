...
[[S17]]
== S17: 22 June
* Graded exercice: https://classroom.github.com/a/a7m6IgaA[various]. You need to complete the VariousClass implementing the Various interface. Double weight. About collections; unit tests; files and flows; logging. 
