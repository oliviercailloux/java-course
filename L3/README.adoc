...
[[S7]]
== S7: 13 Mar
* Graded exercice about syntax, contracts, unit tests: https://github.com/oliviercailloux/java-course/blob/main/Contrat/Books.adoc[Books] (45 minutes plus 15 minutes with increasing penalty)
