...
[[S6]]
== S6: 21 March
* Graded exercice about syntax and contracts: https://classroom.github.com/a/Wa20i3UR[multiply]. _You must disable LLM completions._ Deadline: 14:20 plus five minutes late max.
