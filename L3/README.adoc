...
* Graded exercice about: Eclipse, Contract, Objects, Interfaces, Exceptions. (Might be similar to the https://github.com/oliviercailloux/java-course/blob/master/Objects%20%26%20interfaces/README.adoc#exercice-coffee[Coffee] exercice.)
...
* Graded exercice, _at Dauphine_: mainly about the contents of S7 and S8.
