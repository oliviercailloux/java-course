...
* Graded exercice, _at Dauphine_: mainly about the contents of S7 and S8. You will have to accept an assignment to create your own remote repository and push your commits there; this repository will be initialized with a project and the instructions for this test. *This test will count for three of the previous tests.*
