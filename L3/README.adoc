...
[[S15]]
== S15: 19 June
* Graded exercice about every topics seen in this course (files and flows in particular): https://classroom.github.com/a/jMJEdFAD[computer-customer]. Coefficient is double.
