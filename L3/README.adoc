...
*Also, homework*: 421 again. Follow the instructions https://github.com/oliviercailloux/java-course/blob/main/L3/Exercices%20not%C3%A9s.adoc#nouvelle-chance[here] (no e-mail to me is required in this case). Your grade will be a combination with the original grade, depending on the number of modified lines, as explained on that page. Deadline: *end of 8th of May*. This second chance is optional; if you do not change anything, you will keep your original mark for this exercice.
