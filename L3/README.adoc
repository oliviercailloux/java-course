...
*Release 3* due end of 22 June; counts as 1.5 other releases. *NOTE*: for this last iteration with bigger time range and weighting more, I expect more work than during the other iterations; the SM/POs should also submit at least one task in supplement to their reviewing work.
...
[[S17]]
== S17: 22 June
* Graded exercice. Double weight. About collections; unit tests; files and flows; logging. 
