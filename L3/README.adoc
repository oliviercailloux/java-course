...
* Unit testing, demo, https://github.com/oliviercailloux/java-course/blob/main/JUnit/Overview.adoc[overview]; exercice: write unit tests for some of the above exercices
...
[[S5]]
== S5: 5 April
* Graded exercice about git: you will be asked to create commits and position branches.
