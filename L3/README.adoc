...
TODO @ home: Syntax, More exercices (up to EE3.6 included), Contract up to EE4.4 included.
...
[[S6]]
== S6: 7 April
* Graded exercice about syntax and contracts: you will be asked to clone a repository with Java classes and to write code to implement methods.
