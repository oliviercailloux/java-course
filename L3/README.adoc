...
* At end: random demonstrations using jshell, javac & java
...
* At end: random demonstrations using Eclipse
...
** Javadoc: https://www.lamsade.dauphine.fr/~airiau/Teaching/L3-Java/cours3.pdf[Airiau C3], p. 12 to 19.
