...
* Graded exercice about Eclipse, similar to https://github.com/oliviercailloux/java-course/blob/main/Dev%20tools/Exercice.adoc[this one]. Prerequisite: configure Eclipse as recommended in this course (see above).
