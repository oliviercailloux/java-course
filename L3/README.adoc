...
* Graded exercice: Eclipse, Contract, Objects, Interfaces, `Object`, Exceptions. (Might be similar to the https://github.com/oliviercailloux/java-course/blob/master/Objects%20%26%20interfaces/README.adoc[Coffee] exercice.)
