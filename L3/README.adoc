...
// étudiants non enregistrés dans mon org, Oweys?
[[S6]]
== S6: 20 Feb
* Training (https://app.wooclap.com/events/HDARZP/[poll]): https://github.com/oliviercailloux/java-course/blob/main/Contrat/Multiply.adoc[Multiply] (https://classroom.github.com/a/1G1AoFDf[accept this]).
