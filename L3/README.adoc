...
* Graded test about `Set`, `List`, `Map`, and other classes and interfaces related to the collections in Java; Loggers; and Optionals. To review some of these aspects, answer the https://github.com/oliviercailloux/java-course/blob/master/Objects%20%26%20interfaces/README.adoc[Chess] exercice. Weight: 2.
