...
[[S5]]
== S5: 18 Feb
* Re-create some classes that you designed in “Syntax” in VS Code and make sure you can run the `main` method.
...
[[S6]]
== S6: 20 Feb
* Graded exercice training: https://github.com/oliviercailloux/java-course/blob/main/Contrat/Multiply.adoc[Multiply].
