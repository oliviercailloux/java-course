...
Before end of 14 March: git-branching-2. Submit new attempt at git-branching. Grade git-branching-final: max(git-branching, git-branching × (1 − w) + git-branching-2 × w), w = (20 - a) / 40. Grade git-modify-final: max(git-modify, git-branching-final).
