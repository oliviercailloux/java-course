...
* https://github.com/oliviercailloux/java-course/blob/main/Collections/README.adoc[Collections]: Iterator, Iterable, Collection, Set, List; exercices “defining iterables” and “using collections” (especially EE10.1, 10.2)
...
[[S11]]
== S11: 24 May
* Graded exercice about exceptions, maven, genericity, varargs, collections.
