...
[[S7]]
== S7: 19 April
* Graded exercice about objects and interfaces: https://classroom.github.com/a/O_Hb-4UL[car]. Implement all three classes. 45 minutes, plus 10 minutes with penalty, increasing slowly at first. If you finish early, you must push a branch “end” at your last commit before exitting the room.
