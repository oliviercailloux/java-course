...
* https://github.com/oliviercailloux/java-course/blob/master/Objects%20%26%20interfaces/README.adoc[Objects & interfaces]

[[S6]]
=== S6 (12 Feb)

* The `Object` class (print, equal, hashcode).
...
* Graded exercice: Eclipse, Contract, Objects, Interfaces, Generics. (Practice using the https://github.com/oliviercailloux/java-course/blob/master/Objects%20%26%20interfaces/README.adoc[Coffee] exercice.)
