...
* https://github.com/oliviercailloux/java-course/blob/master/Git/README.adoc[Git]
* Read the https://github.com/oliviercailloux/java-course/blob/master/Git/Graded%20exercices.adoc[graded exercices] procedure and take the “training” assignment
* Practice with https://github.com/oliviercailloux/java-course/blob/master/Git/Reinitialization.adoc[reinitializing] history
* Train with the more serious assignments: https://github.com/oliviercailloux/java-course/blob/master/Git/Git%20branching.adoc[Git branching]; https://github.com/oliviercailloux/java-course/blob/master/Git/Git-br-2018.adoc[Git-br-2018]; https://github.com/oliviercailloux/java-course/blob/master/Git/Git-br-2019.adoc[Git-br-2019]
...
* Graded exercice ). 25 minutes: 13:52 to 14:17 (or 14:22 max for late commits).
