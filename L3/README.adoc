...
Deadline end of Sunday 28 May: commit a second chance for Colors with a doc that explains the differences compared to your initial proposition.
...
TODO @ home: move project forward
