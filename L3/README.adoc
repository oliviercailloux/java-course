...
// students that were not registered to my course?
// machine lab
...
[[S6]]
== S6: 20 Feb
* Graded exercice about syntax and contracts (previous year, https://github.com/oliviercailloux/java-course/blob/main/Contrat/Multiply.adoc[Multiply]). _You must disable LLM completions._
