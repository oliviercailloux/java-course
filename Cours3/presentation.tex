...
\begin{frame}
	...
	\begin{itemize}
		\item Le conteneur fournit une vue client pour donner accès (Pattern ? \pause Proxy !)
...
\begin{frame}[fragile]
	...
	\lstinputlisting[firstline=11, lastline=15, basicstyle=\scriptsize]{MySesEjbBean.java}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		\item \href{http://docs.oracle.com/javaee/7/tutorial/partentbeans.htm}{The Java EE Tutorial: Enterprise Beans}
