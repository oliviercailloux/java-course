...
== curl
=== Set up
* Read link:HTTP.adoc[HTTP] and in particular the section about curl
* Install curl on your machine

=== Using curl
Warm up. We download an HTML page.
...
Simple API use. We use JSONPlaceholder, a simple web service that delivers fake data.
...
Real-life API use. We get some data from Wikipedia.
