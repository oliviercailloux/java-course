...
\subtitle{Services Web REST}
\subject{Java EE}
\keywords{REST, JAXB, Web services}
...
\begin{frame}[fragile]
	\frametitle{Client}
	\begin{itemize}
		\item \jeeref{javax.ws.rs.client/Client} : point d’entrée
		\item \jeeref{javax.ws.rs.client/WebTarget} pour manipuler des URIs
	\end{itemize}
	\begin{block}{Exemple}%
%		\lstinputlisting[language=Java,basicstyle=\NoAutoSpacing]{Client.java}
...
/** http://example.com/users/123?prof=1 */
...
\begin{frame}
	...
	\begin{itemize}
		\item \href{http://dx.doi.org/10.1145/337180.337228}{Article} REST : Fielding \& Taylor, Principled Design of the Modern Web Architecture (\href{https://www.ics.uci.edu/~fielding/pubs/webarch_icse2000.pdf}{direct})%http://dx.doi.org.gate6.inist.fr/10.1145/337180.337228
