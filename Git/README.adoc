...
* https://github.com/oliviercailloux/java-course/blob/main/Git/Git%20branching%201.adoc[Git branching 1] and https://github.com/oliviercailloux/java-course/blob/main/Git/Git%20branching%202.adoc[Git branching 2], 
