...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Créé par ? \onslide<3->{Linus \href{https://en.wikipedia.org/wiki/Linus_Torvalds}{Torvalds} (\string?)} \onslide<4>{Créateur du noyau Linux}
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\href{https://learngitbranching.js.org/?NODEMO}{Illustration}
\end{frame}
