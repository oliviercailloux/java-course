...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Circuler en utilisant la commande \texttt{git checkout <SHA-1>}
	\end{itemize}
	\begin{center}
		\begin{tikzpicture}
...
%			\item[] \texttt{/.git}
	...
	\end{minipage}
	\begin{itemize}
		\item \emph{HEAD} : commit actuel
		\item \emph{Index} : zone de stockage du commit en préparation
		\item Initialisation nouveau dépôt ? \onslide<2->{HEAD non existant, Index vide}
