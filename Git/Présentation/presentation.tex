...
\begin{frame}
	\center\href{https://imgs.xkcd.com/comics/git.png}{\includegraphics[width = \textwidth, height = \textheight, keepaspectratio]{xkcd.png}}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Git ? \onslide<2->{Local (!), centralisé ou distribué ⇒ tout le monde a une copie complète de l’historique}
...
\begin{frame}
	...
	\begin{itemize}
		\item Branches pointent vers des commits
		\item Pointeur HEAD vers la branche actuelle
		\item Indique le commit d’où est issu la version actuelle
		\item Circuler en utilisant la commande \emph{checkout} (commit ou branche)
	\end{itemize}
	{
		\centering
		\begin{tikzpicture}
...
\begin{frame}
	...
	\end{itemize}
	Cf. démo commande et \href{https://git-school.github.io/visualizing-git/}{graphique}
\end{frame}
