...
\begin{frame}
	...
	\begin{itemize}
		\item Pointent vers des commits ou vers d’autres refs
		\item Branches et références spéciales
		\item Branche : pointeur vers un commit
		\item HEAD : pointeur vers une branche {\tiny (typiquement)} et un commit
		\item Branche et commit \emph{actuels} désignés par HEAD
