...
** use (Windows) https://docs.microsoft.com/powershell/scripting/install/installing-windows-powershell[PowerShell] (recommended for power users).
...
== Basics
Read https://tutorial.djangogirls.org/en/intro_to_command_line/[Introduction to the command-line interface] for the very basics of using a shell. Use ↑ (keyboard up https://en.wikipedia.org/wiki/Arrow_keys[arrow]) to reuse previous commands. (https://www.lamsade.dauphine.fr/~bnegrevergne/ens/Unix/static/TP_Shell_Unix.pdf[This tutorial] could help as well.)
...
This course uses Unix-like commands (in particular, uses forward slashes to separate paths), which you should be able to use in any of the environments listed here above: Git BASH provides a Unix-like environment and PowerShell https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_path_syntax[authorizes] this use.
