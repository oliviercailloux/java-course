...
* Accept the graded exercice: https://classroom.github.com/a/LCPLFURG[git branching] (or https://classroom.github.com/a/I4ln26cK[here] in case of problems). This creates a repository for you.
