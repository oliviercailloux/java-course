...
* Accept the graded exercice: https://classroom.github.com/a/LCPLFURG[git branching] (or https://classroom.github.com/a/I4ln26cK[here] in case of problems, or fork https://github.com/oliviercailloux/google-or-tools-java/[this]). This creates a repository for you.
** Your repository currently has one commit, with several files and folders (which we will not modify). I’ll refer to it as “Start”.
