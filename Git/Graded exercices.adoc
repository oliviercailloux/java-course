...
La version considérée comme originale est choisie à votre avantage parmi le dernier commit à l’heure et tous vos commits en retard (à votre avantage signifiant que le choix est celui qui maximise la note résultante).
