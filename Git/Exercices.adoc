...
(Solutions diagrams are here: https://cdn.rawgit.com/oliviercailloux/java-course/master/Git/Merged1.svg[Merged1], https://cdn.rawgit.com/oliviercailloux/java-course/master/Git/Merged2.svg[Merged2]. Don’t cheat! Solve the exercice before looking.)
