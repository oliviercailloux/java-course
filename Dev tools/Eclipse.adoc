...
* From Eclipse, import this https://raw.githubusercontent.com/oliviercailloux/java-course/master/Best%20practices/Eclipse-prefs.epf[epf] (Eclipse Preference File) (save it on your computer first), with `File` / `Import…` (look into `General` / `Preferences`).
