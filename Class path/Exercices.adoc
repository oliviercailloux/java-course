...
== Solution
The https://github.com/oliviercailloux/java-course/blob/master/Class%20path/Solution/[solution] is available as a bash script and two folders containing the source code.
