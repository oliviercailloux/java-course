...
* https://git-scm.com/book/en/v2/Getting-Started-First-Time-Git-Setup[Configure] your git identity: `user.name` and `user.email`. (Specific for GitHub: https://help.github.com/en/articles/setting-your-username-in-git[user.name], https://help.github.com/en/articles/setting-your-email-in-git[user.email].)
