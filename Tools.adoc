...
* Eclipse https://www.eclipse.org/downloads/packages/eclipse-ide-java-developers/neon1a[Neon] Java
* http://www.oracle.com/technetwork/java/javase/downloads/index.html[Java] 8

== Java EE

* Eclipse https://www.eclipse.org/downloads/packages/eclipse-ide-java-ee-developers/neon1a[Neon] Java EE
