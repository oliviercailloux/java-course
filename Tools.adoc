...
* From Eclipse, import my sample preference https://raw.githubusercontent.com/edoreld/java-course/patch-1/Best%20practices/Eclipse-prefs.epf[epf] file (Eclipse preference). 
