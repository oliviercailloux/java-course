...
* Clean and recompile your projects to see the effect. (And check in your project properties, `Java Compiler / Errors/Warnings` that the project uses your global Eclipse compiler settings.)
