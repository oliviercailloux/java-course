...
\begin{frame}
	...
	\begin{itemize}
		...
		\item C++ est le plus souvent compilé en code machine (puis \hrefblue{https://stackoverflow.com/a/9547498/}{interprété} par le CPU, ou \og{}exécuté\fg{})
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Donner à \texttt{javac} les fichiers à compiler : ? \onslide<2->{\texttt{javac "My project/src/me/myapp/mytheme/MyClass.java"}}
		\item Donner à \texttt{java} le nom \emph{complet} de la classe à exécuter : ? \onslide<3->{\texttt{java "me.myapp.mytheme.MyClass"}}
		\item Mais que manque-t-il ? \onslide<4->{Où trouver cette classe !}
		...
		\item Exemple : ? \onslide<5->{\texttt{java -cp "My project/src/" "me.myapp.mytheme.MyClass"}}
	\end{itemize}
\end{frame}
