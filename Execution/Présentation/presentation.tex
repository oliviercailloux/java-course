...
\begin{frame}
	...
	\begin{enumerate}
		\item \label{unik} JVM système + fichiers \texttt{.class}, séparément
		\begin{itemize}
	...
	\end{enumerate}
	Dans ce cours : JVM système (\ref{unik}) ; Projet : serveur (\ref{srv})
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Exemple : \zeroboxonly{1-4}{?}\uncover<5->{\texttt{java -cp "My project/target/" "me.myapp.mytheme.MyClass"}}
	\end{itemize}
\end{frame}
