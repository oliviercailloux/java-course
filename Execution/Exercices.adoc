...
== Solution
The https://github.com/oliviercailloux/java-course/tree/master/Execution/Solution/[solution] is available as a bash script and two folders containing the source code.
