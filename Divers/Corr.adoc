...
| TEST	| Des tests unitaires ou fonctionnels couvrent les fonctionnalités demandées	| http://www.lamsade.dauphine.fr/~airiau/Teaching/L3-Java/cours9.pdf[Airiau C9]	| −1
