...
* Je donnerai au groupe trois notes durant l’année sur l’aspect régularité (voir exigences livraisons).
* La moyenne de ces trois notes constitue la note régularité.
* La note CC est le minimum de la note régularité et de la moyenne de vos notes qualité.
