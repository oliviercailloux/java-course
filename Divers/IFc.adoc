...
=== Choix du projet
Vous pouvez soit continuer à développer le projet sur lequel vous aviez travaillé pendant l’année avec votre groupe, soit repartir de zéro avec un autre énoncé de projet. Pour rappel, les projets disponibles sont : Collaborative exams, Dauphine Open Data, J-XMCDA. (Voir site GitHub pour les énoncés.)

=== Contenu et contributions
Les technologies importantes pour intégration dans le projet sont : Maven ; Servlets ; CDI ; JPA. Il vous faudra fournir une contribution significative impliquant chacune de ces quatre technologies.
