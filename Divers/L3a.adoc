...
* Your GitHub username and git “User Name” must be identical.
* https://classroom.github.com/a/aiweSTSU[Git] (marked /10): use this repository (created when you accept the homework) at the last step of the git exercices above, connect your local repository to it, and so on (follow the instructions in the exercice).
