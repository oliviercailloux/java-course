...
=== Projets
//Considérer : une note par livraison. Peu fait, pénalisation sur la note (mais c’est surtout la qualité qui compte). Beaucoup, la note compte double, ou reçoit une note bonus après 2×1,5. Rien : zéro. Prévoir date livraison initiale et livraison finale. Non approuvé : noté qd-même, avec pénalisation à choisir pour code de mauvaise qualité ou fct inutile (si erreur du candidat). On peut poursuivre une fct non encore approuvée à l’itération suivante. Il faut un scrum master tournant, vérifie la cohérence du cahier des charges et prérequis, réactions à temps quand retour en modif. Équipes 5 à 7 : un scrum master qui analyse et gère, et deux ou trois binômes qui codent (ou un tout seul occasionnellement avec son scrum master, mais je préfère pas).
...
[[S6]]
=== S6 (Tuesday 16th of April, 2019)

*Lecture*

* https://github.com/oliviercailloux/java-course/tree/master/Maven[Maven]
* Use https://mvnrepository.com/artifact/com.google.guava/guava/24.1-jre[Guava] `https://github.com/google/guava/wiki/PreconditionsExplained[Preconditions]#checkArgument`
...
[[S7]]
=== S7 (Thursday 18th of April, 2019)
...
* https://github.com/oliviercailloux/java-course/blob/master/Best%20practices/Resources.adoc[Resources]
...
* Read Best Practices
* Read https://github.com/oliviercailloux/java-course/blob/master/Tools.adoc#eclipse[Eclipse] doc (or equivalent)
...
* Project: Resources (cf. Best Practices, )
