...
* Create a personal repository named `Java-L3-Eck-Ex`. Deposit the mandatory (suffixed with [M]) book exercices (prefixed with EE) there, 3 days before the next session. All related classes must be prefixed with EExx, for example EE34MyClass.

=== S2 (Thursday 22nd of February, 2018)
