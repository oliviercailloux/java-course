...
| UNIK	| noms des classes est unique et respecte les bonnes pratiques	| Class path ; S3	| 0
...
| FORMAT	| le code est mis en forme systématiquement	| https://github.com/oliviercailloux/java-course/blob/master/Best%20practices/Style.adoc[BP Style]	| 0
...
| FOLDER	| la racine du dépôt est la racine du projet	| https://github.com/oliviercailloux/java-course/blob/master/Best%20practices/Git.adoc[BP Git]	| 0
|===
...
.. conventions respectées ? (noms de variables et méthodes en camelCase, de classes en FirstCap, de packages avec première lettre minuscule, …)
...
* Tools: use correct Eclipse config. (Check warnings, compile errors, instructions!)
