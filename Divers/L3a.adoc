...
* Create a group repository (once for the group). It must have _exactly_ the name given in the title of your project description, except using - instead of spaces: do not change case, add spaces, use \_ instead of -, … Do _not_ send me an e-mail to tell me your project url: I’ll find it.
