...
* For the book exercices, you receive either 1 (exercice is done, even imperfectly) or 0 (exercice not done). This counts for 10% of the CC grade.
* The final grade is a mix of 50% CC grade, 50% Project grade.

== S1 (11th Jan)

* https://github.com/oliviercailloux/java-course/blob/master/Pr%C3%A9sentation%20du%20cours%20Objet/presentation.pdf[Pres course]
...
* https://github.com/oliviercailloux/java-course/blob/master/Git/presentation.pdf[Git] #(w/o merge?)
* https://github.com/oliviercailloux/java-course/blob/master/Notions%20objets/presentation.pdf[Basics of objects]
* Choose your project
