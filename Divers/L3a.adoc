...
* Read parts of https://github.com/oliviercailloux/java-course/blob/master/Tools.adoc#eclipse[Eclipse] doc [I]
...
* EE2.7: you may use user input (Scanner) instead of file input; do not use TextIO
