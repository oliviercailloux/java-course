...
* Create a personal repository named `Java-L3-Eck-Ex`. Deposit the mandatory (suffixed with [M]) book exercices (prefixed with EE) there. All related classes must be prefixed with EExx, for example EE34MyClass.
* Your GitHub username and git “User Name” must be identical.
