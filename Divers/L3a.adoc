...
* Créez une pull request GitHub par EF et https://help.github.com/articles/assigning-issues-and-pull-requests-to-other-github-users/[affectez-y] la  ou les deux personnes responsables.
...
** http://www.lamsade.dauphine.fr/~airiau/Teaching/L3-Java/cours0.pdf[Airiau C0], http://www.lamsade.dauphine.fr/~airiau/Teaching/L3-Java/cours1.pdf[Airiau C1] (compil, p. 16 to 20)
...
* http://www.vogella.com/tutorials/JUnit/article.html[Unit testing]
