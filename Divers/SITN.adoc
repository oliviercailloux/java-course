...
** Note 2 : deux jours avant S6 (≥ 7 points de difficulté ; Tests doivent passer sur Travis CI)
...
=== S5
//* App online : https://dauphine.onthehub.com/
* https://github.com/oliviercailloux/java-course/raw/master/CDI/presentation.pdf[CDI]
* https://github.com/oliviercailloux/java-course/raw/master/JPA/presentation.pdf[JPA]
