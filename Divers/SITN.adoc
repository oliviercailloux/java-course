...
* L’auteur reçoit une note qualité et un nombre de points de difficultés lorsque la fct est acceptée (code fusionné dans master). Voir https://github.com/oliviercailloux/java-course/tree/master/Best%20practices[Bonnes pratiques] et https://github.com/oliviercailloux/java-course/blob/master/Corr.adoc[Corr].
...
* https://github.com/oliviercailloux/java-course/tree/master/Git[Git] : présentation & exercices
...
* https://github.com/oliviercailloux/java-course/tree/master/WS%20client.adoc[Client WS]
...
. https://github.com/oliviercailloux/java-course/tree/master/WS%20client.adoc[Client WS], partie curl (la partie Java sera vue en S2)
...
* https://github.com/oliviercailloux/java-course/tree/master/Maven[Maven] : présentation & exercices
* Exercices client WS (lien ci-dessus)
* https://github.com/oliviercailloux/java-course/raw/master/Java%20EE/presentation.pdf[Intro] Java EE, https://github.com/oliviercailloux/java-course/tree/master/WildFly.adoc[Familiarisation] avec WildFly
