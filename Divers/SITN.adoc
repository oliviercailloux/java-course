...
* https://www.getpostman.com/[Postman] (et https://dauphine.onthehub.com/)
* Tests unitaires
...
* Servlets multi-formats (https://en.wikipedia.org/wiki/JSON[JSON], XML voir références générales ci-dessus)
* Discussion projets
* JAX-B : exemple https://github.com/oliviercailloux/XMCDA-2.2.1-JAXB[classique], https://github.com/xmcda-modular/jaxb[avancé] (http://pyxb.sourceforge.net/[PyXB], https://docs.microsoft.com/en-us/dotnet/standard/serialization/xml-schema-definition-tool-xsd-exe[.NET], …)
