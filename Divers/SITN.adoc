...
* Créez une issue GitHub par EF et indiquez comme https://help.github.com/articles/assigning-issues-and-pull-requests-to-other-github-users/[“assignee”] la personne responsable, pour que je m’y retrouve.
...
* Vous pouvez échanger des pistes de solutions entre vous et discuter de votre code, mais pas travailler ensemble sur le code. je vous demande un rendu individuel. Je vous ne pouvez pas rendre un code identique ou ressemblant fortement à celui d’un autre étudiant.
