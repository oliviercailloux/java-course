...
https://classroom.github.com/a/jOKznGsT[Devoir] : un projet avec intégration continue Travis (et un badge dans le `README.adoc`), un servlet simple `HelloServlet`, et un test unitaire JUnit 5. À rendre avant la fin du mardi 11 décembre.
