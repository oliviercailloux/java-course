...
//org.eclipse:yasson:1.0.3 provides org.eclipse.yasson.
//depends on: jakarta.json.bind:jakarta.json.bind-api:1.0.1
//	jakarta.json:jakarta.json-api:1.1.5
//	org.glassfish:jakarta.json:1.1.5:module, test scope
