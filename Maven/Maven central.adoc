...
If deployment is successful, your artifacts should be immediately visible https://oss.sonatype.org/content/repositories/snapshots/io/[here] (replace the “io” part of this URL with your maven coordinates, for example, my snapshots are visible https://repo1.maven.org/maven2/io/github/oliviercailloux/[here]).
