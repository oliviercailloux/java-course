...
\begin{frame}
	...
	\begin{example}[JasperReports]
		\begin{itemize}
			\item 18 dépendances {\tiny (\href{http://search.maven.org/\#artifactdetails|net.sf.jasperreports|jasperreports|6.4.0|jar}{Central}, \href{https://mvnrepository.com/artifact/net.sf.jasperreports/jasperreports/6.4.0}{détails})}
...
<dependency>
  ...
  <version>21.0</version>
		...
		\end{lstlisting}	
	\end{block}
	\begin{block}{Exemple : dépendance vers \href{http://search.maven.org/\#search|gav|1|g:"junit" AND a:"junit"}{junit}}
		\begin{lstlisting}
<dependency>
