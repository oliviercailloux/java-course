...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Représentation sous formes diverses (\href{http://www.iana.org/assignments/media-types/}{liste} \href{https://tools.ietf.org/html/rfc7231\#section-3.1.1.1}{media-types})
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		\item \href{http://doi.org/10.1145/337180.337228}{Article} REST : Fielding \& Taylor, Principled Design of the Modern Web Architecture (\href{https://doi-org.proxy.bu.dauphine.fr/10.1145/337180.337228}{Dauphine}, \href{https://www.ics.uci.edu/~fielding/pubs/webarch_icse2000.pdf}{direct})
